...
class UserReposRecyclerAdapter : RecyclerView.Adapter<UserReposRecyclerAdapter.ViewHolder>() {
    ...
    private var userRepos: List<RepoEntity> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_user_repo, parent, false)
    ...
    fun updateUserRepos(userRepos: List<RepoEntity>) {
